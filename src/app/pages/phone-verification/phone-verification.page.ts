...
export class PhoneVerificationPage implements OnInit {
  ...
  //   if(this.number){
  //     this.api.startLoad();
  //     let codeWithNumber = this.code+this.number.toString()
  //     let d = new FormData()
  //     d.append('id',this.user.id)
  //     d.append('phone',codeWithNumber)
  
  //     this.api.post('verifyPhone',d).subscribe((res:any) => {
  //       if(res.success){
  //         this.user.phone = this.number
  //         this.user.forVerify = codeWithNumber
  //         this.api.user.next(this.user)
  ...
  //   }
  //   else{
  //     this.api.error('','Without number how we can verify you ? :(')
  //   }
